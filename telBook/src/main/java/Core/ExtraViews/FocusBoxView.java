...
public class FocusBoxView extends View {
    ...
    private  Rect getBoxRect() {
        ...
        //初始化box，宽度为手机屏幕宽度的6/7 高度为手机屏幕高度的1/9 且box居中
        if (box == null) {
            ...
            //box宽度最小不能小于MIN_FOCUS_BOX_WIDTH  高度最小不能小于MIN_FOCUS_BOX_HEIGHT
            width = width == 0
                    ? MIN_FOCUS_BOX_WIDTH
